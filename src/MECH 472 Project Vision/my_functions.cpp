...
int process_image(image& rgb, image& label, bool draw_ics, bool light_bg) {
	int nlabels;
	int R, G, B;
	...
	image a, b;  // declare all images you'll need upfront
	...
	allocate_image(a);     allocate_image(b);
	...
	save_rgb_image("image_output.bmp", rgb);   // professor often saves intermediate images
